  ...
  return (
    <div className="container mx-auto sm:grid sm:grid-cols-12 sm:gap-8  sm:my-24 my-14 items-center w-[90%] md:text-left text-center">
      <div className="col-span-7 ">
        <h1 className="font-Inter font-extrabold md:text-6xl  text-4xl sm:leading-15 leading-10 sm:mb-6 mb-2 tracking-[-1.5px]">
          Build Your Ideal <br />
          <span className="bg-linear-to-r from-prime via-secs to-acce bg-clip-text text-transparent">
            Development Stack
          </span>
        </h1>
        <p className="font-Jakarta sm:text-lg text-sm leading-7 sm:max-w-7/12 mb-10">
